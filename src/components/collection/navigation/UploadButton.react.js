...
var UploadButton = React.createClass({
  ...
  render: function () {
    ...
    return (
      <button
        style={uploadButtonStyle} className={`${this.props.activateButton && "wgsa-sonar-effect"} mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored mdl-shadow--4dp`}
