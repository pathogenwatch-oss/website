...
var SetProjectEmail = React.createClass({
  ...
  handleChange: function (event) {
    ...
    if (this.isValid(inputValue)) {
      this.props.handleProjectMetadata('email', inputValue);
    } else {
      this.props.handleProjectMetadata('email', null);
    }
  },
    ...
    return (
      <form style={formStyle} onSubmit={this.handleSubmit}>
        <div className="form-group">
          <label htmlFor="metadataInput" style={labelStyle}>What is your email address: { this.props.isRequired ? <spna style={requireStyle}>*</spna> : null }</label>
...
module.exports = SetProjectEmail;
