...
var Tree = React.createClass({
  ...
  componentDidMount: function () {
    var phylocanvas = new PhyloCanvas.Tree(this.props.treeId, {
      history: {
        collapsed: true
      }
    });
    phylocanvas.dangerouslySetData(this.props.tree);
  ...
  render: function () {
    ...
    return (
      <section style={sectionStyle}>
        <div id={this.props.treeId} style={phylocanvasStyle}></div>
